  ...
  .factory('Tab',
    ['_', '$log', 'Authentication', 'lsAppConfig',
      function (_, $log, Authentication, lsAppConfig) {
        ...
        var statistics = {
          name: 'COMMON.TAB.STATISTICS',
          icon: 'fa-bar-chart-o',
          superAdminOnly: false,
          links: [
            {
              name: 'COMMON.TAB.STATISTICS_QUOTA',
              superAdminOnly: false,
              sref: 'statistic.quota'
            }, {
              name: 'COMMON.TAB.STATISTICS_BASIC',
              superAdminOnly: false,
              sref: 'statistic.basic'
            }, {
              name: 'COMMON.TAB.STATISTICS_EXCEPTON',
              superAdminOnly: false,
              sref: 'statistic.exception'
            }
          ]
        };
        ...
        this.tabs = [parameters, users, history, domains, mails, statistics];
