...
angular.module('linshareAdminApp').config(['_', '$stateProvider', '$urlRouterProvider',
  function (_, $stateProvider, $urlRouterProvider) {
    ...
    var enumResourceTypes = function (Enum) {
      return Enum.getOptions('audit_log_entry_type');
    };
    var authenticatedUser = function (Authentication) {
      return Authentication.getCurrentUser();
    };
    var enumLogActions = function (Enum) {
      return Enum.getOptions('log_action_v1');
    };
    // Common views
    var domainTreeView = {
    ...
    $stateProvider
      ...
      .state('user.detail', {
        ...
        resolve: {
          ...
          usermonthlystatistics: function (Statistic, currentUser) {
            return Statistic.getAccountStatistics(currentUser.uuid, "USER_MONTHLY_STAT");
          },
          userweeklystatistics: function (Statistic, currentUser) {
            return Statistic.getAccountStatistics(currentUser.uuid, "USER_WEEKLY_STAT");
          },
          userdailystatistics: function (Statistic, currentUser) {
            return Statistic.getAccountStatistics(currentUser.uuid, "USER_DAILY_STAT");
          },
          statUserMonthlyGraphDataSum: function (GraphOptionsService, usermonthlystatistics) {
            return GraphOptionsService.generateSizeChartDatas(usermonthlystatistics);
          },
          statUserWeeklyGraphDataSum: function (GraphOptionsService, userweeklystatistics) {
            return GraphOptionsService.generateSizeChartDatas(userweeklystatistics);
          },
          statUserDailyGraphDataSum: function (GraphOptionsService, userdailystatistics) {
            return GraphOptionsService.generateSizeChartDatas(userdailystatistics);
          },
          statUserMonthlyUsedSpaceGraphData: function (GraphOptionsService, usermonthlystatistics) {
            return GraphOptionsService.generateUsedSpaceChartDatas(usermonthlystatistics);
          },
          statUserWeeklyUsedSpaceGraphData: function (GraphOptionsService, userweeklystatistics) {
            return GraphOptionsService.generateUsedSpaceChartDatas(userweeklystatistics);
          },
          statUserDailyUsedSpaceGraphData: function (GraphOptionsService, userdailystatistics) {
            return GraphOptionsService.generateUsedSpaceChartDatas(userdailystatistics);
          },
          statUserMonthlyGraphDataCount: function (GraphOptionsService, usermonthlystatistics) {
            return GraphOptionsService.generateOperationsChartDatas(usermonthlystatistics);
          },
          statUserWeeklyGraphDataCount: function (GraphOptionsService, userweeklystatistics) {
            return GraphOptionsService.generateOperationsChartDatas(userweeklystatistics);
          },
          statUserDailyGraphDataCount: function (GraphOptionsService, userdailystatistics) {
            return GraphOptionsService.generateOperationsChartDatas(userdailystatistics);
          },
          fileSizeChartOptions: function (GraphOptionsService) {
            return GraphOptionsService.generateSizeChartOptions();
          },
          operationsChartOptions: function (GraphOptionsService) {
            return GraphOptionsService.generateCountChartOptions();
          },
          UserDatas: function (GraphOptionsService, statUserMonthlyGraphDataSum, statUserWeeklyGraphDataSum, statUserDailyGraphDataSum,
            ...
            return GraphOptionsService.buildUserGraphData(statUserMonthlyGraphDataSum, statUserWeeklyGraphDataSum, statUserDailyGraphDataSum,
              statUserMonthlyUsedSpaceGraphData, statUserWeeklyUsedSpaceGraphData, statUserDailyUsedSpaceGraphData,
              statUserMonthlyGraphDataCount, statUserWeeklyGraphDataCount, statUserDailyGraphDataCount);
          },
      ...
      .state('thread.detail', {
        ...
        resolve: {
          ...
          workgroupmonthlystatistics: function (Statistic, currentThread) {
            return Statistic.getAccountStatistics(currentThread, "WORK_GROUP_MONTHLY_STAT");
          },
          workgroupweeklystatistics: function (Statistic, currentThread) {
            return Statistic.getAccountStatistics(currentThread, "WORK_GROUP_WEEKLY_STAT");
          },
          workgroupdailystatistics: function (Statistic, currentThread) {
            return Statistic.getAccountStatistics(currentThread, "WORK_GROUP_DAILY_STAT");
          },
          fileSizeChartOptions: function (GraphOptionsService) {
            return GraphOptionsService.generateSizeChartOptions();
          },
          ...
          statWorkgroupMonthlyGraphDataSum: function (GraphOptionsService, workgroupmonthlystatistics) {
            return GraphOptionsService.generateSizeChartDatas(workgroupmonthlystatistics);
          },
          statWorkgroupWeeklyGraphDataSum: function (GraphOptionsService, workgroupweeklystatistics) {
            return GraphOptionsService.generateSizeChartDatas(workgroupweeklystatistics);
          },
          statWorkgroupDailyGraphDataSum: function (GraphOptionsService, workgroupdailystatistics) {
            return GraphOptionsService.generateSizeChartDatas(workgroupdailystatistics);
          },
          statWorkgroupMonthlyUsedSpaceGraphData: function (GraphOptionsService, workgroupmonthlystatistics) {
            return GraphOptionsService.generateUsedSpaceChartDatas(workgroupmonthlystatistics);
          },
          statWorkgroupWeeklyUsedSpaceGraphData: function (GraphOptionsService, workgroupweeklystatistics) {
            return GraphOptionsService.generateUsedSpaceChartDatas(workgroupweeklystatistics);
          },
          statWorkgroupDailyUsedSpaceGraphData: function (GraphOptionsService, workgroupdailystatistics) {
            return GraphOptionsService.generateUsedSpaceChartDatas(workgroupdailystatistics);
          },
          statWorkgroupMonthlyGraphDataCount: function (GraphOptionsService, workgroupmonthlystatistics) {
            return GraphOptionsService.generateOperationsChartDatas(workgroupmonthlystatistics);
          },
          statWorkgroupWeeklyGraphDataCount: function (GraphOptionsService, workgroupweeklystatistics) {
            return GraphOptionsService.generateOperationsChartDatas(workgroupweeklystatistics);
          },
          statWorkgroupDailyGraphDataCount: function (GraphOptionsService, workgroupdailystatistics) {
            return GraphOptionsService.generateOperationsChartDatas(workgroupdailystatistics);
          },
          WorkGroupDatas: function (GraphOptionsService, statWorkgroupMonthlyGraphDataSum, statWorkgroupWeeklyGraphDataSum, statWorkgroupDailyGraphDataSum,
            ...
            return GraphOptionsService.buildWorkGroupGraphData(statWorkgroupMonthlyGraphDataSum, statWorkgroupWeeklyGraphDataSum, statWorkgroupDailyGraphDataSum,
              statWorkgroupMonthlyUsedSpaceGraphData, statWorkgroupWeeklyUsedSpaceGraphData, statWorkgroupDailyUsedSpaceGraphData,
              statWorkgroupMonthlyGraphDataCount, statWorkgroupWeeklyGraphDataCount, statWorkgroupDailyGraphDataCount);
          },
        }
      ...
      .state('statistic', {
        abstract: true,
        url: '/statistic',
        templateUrl: 'ng_components/statistics/statistics.html',
        resolve: {
          treeTitle: function () {
            return 'COMMON.TAB.STATISTICS';
          },
          treeType: function () {
            return 'read';
          },
      ...
      .state('statistic.quota', {
        url: '/:domainId/graph',
        views: {
          'tree': domainTreeView,
          'graph': {
            templateUrl: 'ng_components/statistics/statistics_graph.tpl.html',
            controller: 'StatisticGraphCtrl',
            resolve: {
              currentDomain: function (Domain, $stateParams) {
                return Domain.get($stateParams.domainId);
              },
              monthlystatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "DOMAIN_MONTHLY_STAT");
              },
              weeklystatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "DOMAIN_WEEKLY_STAT");
              },
              dailystatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "DOMAIN_DAILY_STAT");
              },
              monthlyuserstatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "USER_MONTHLY_STAT");
              },
              weeklyuserstatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "USER_WEEKLY_STAT");
              },
              dailyuserstatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "USER_DAILY_STAT");
              },
              monthlygroupstatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "WORK_GROUP_MONTHLY_STAT");
              },
              weeklygroupstatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "WORK_GROUP_WEEKLY_STAT");
              },
              dailygroupstatistics: function (Statistic, currentDomain) {
                return Statistic.getDomainStatistics(currentDomain.identifier, "WORK_GROUP_DAILY_STAT");
              },
              fileSizeChartOptions: function (GraphOptionsService) {
                return GraphOptionsService.generateSizeChartOptions();
              },
              ...
              statMonthlyDomainGraphDataSum: function (GraphOptionsService, monthlystatistics) {
                return GraphOptionsService.generateSizeChartDatas(monthlystatistics);
              },
              statWeeklyDomainGraphDataSum: function (GraphOptionsService, weeklystatistics) {
                return GraphOptionsService.generateSizeChartDatas(weeklystatistics);
              },
              statDailyDomainGraphDataSum: function (GraphOptionsService, dailystatistics) {
                return GraphOptionsService.generateSizeChartDatas(dailystatistics);
              },
              statMonthlyUserGraphDataSum: function (GraphOptionsService, monthlyuserstatistics) {
                return GraphOptionsService.generateSizeChartDatas(monthlyuserstatistics);
              },
              statWeeklyUserGraphDataSum: function (GraphOptionsService, weeklyuserstatistics) {
                return GraphOptionsService.generateSizeChartDatas(weeklyuserstatistics);
              },
              statDailyUserGraphDataSum: function (GraphOptionsService, dailyuserstatistics) {
                return GraphOptionsService.generateSizeChartDatas(dailyuserstatistics);
              },
              statMonthlyGroupGraphDataSum: function (GraphOptionsService, monthlygroupstatistics) {
                return GraphOptionsService.generateSizeChartDatas(monthlygroupstatistics);
              },
              statWeeklyGroupGraphDataSum: function (GraphOptionsService, weeklygroupstatistics) {
                return GraphOptionsService.generateSizeChartDatas(weeklygroupstatistics);
              },
              statDailyGroupGraphDataSum: function (GraphOptionsService, dailygroupstatistics) {
                return GraphOptionsService.generateSizeChartDatas(dailygroupstatistics);
              },
              statMonthlyDomainUsedSpaceGraphData: function (GraphOptionsService, monthlystatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(monthlystatistics);
              },
              statWeeklyDomainUsedSpaceGraphData: function (GraphOptionsService, weeklystatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(weeklystatistics);
              },
              statDailyDomainUsedSpaceGraphData: function (GraphOptionsService, dailystatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(dailystatistics);
              },
              statMonthlyUserUsedSpaceGraphData: function (GraphOptionsService, monthlyuserstatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(monthlyuserstatistics);
              },
              statWeeklyUserUsedSpaceGraphData: function (GraphOptionsService, weeklyuserstatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(weeklyuserstatistics);
              },
              statDailyUserUsedSpaceGraphData: function (GraphOptionsService, dailyuserstatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(dailyuserstatistics);
              },
              statMonthlyGroupUsedSpaceGraphData: function (GraphOptionsService, monthlygroupstatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(monthlygroupstatistics);
              },
              statWeeklyGroupUsedSpaceGraphData: function (GraphOptionsService, weeklygroupstatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(weeklygroupstatistics);
              },
              statDailyGroupUsedSpaceGraphData: function (GraphOptionsService, dailygroupstatistics) {
                return GraphOptionsService.generateUsedSpaceChartDatas(dailygroupstatistics);
              }, statMonthlyDomainGraphDataCount: function (GraphOptionsService, monthlystatistics) {
                return GraphOptionsService.generateOperationsChartDatas(monthlystatistics);
              },
              statWeeklyDomainGraphDataCount: function (GraphOptionsService, weeklystatistics) {
                return GraphOptionsService.generateOperationsChartDatas(weeklystatistics);
              },
              statDailyDomainGraphDataCount: function (GraphOptionsService, dailystatistics) {
                return GraphOptionsService.generateOperationsChartDatas(dailystatistics);
              },
              statMonthlyUserGraphDataCount: function (GraphOptionsService, monthlyuserstatistics) {
                return GraphOptionsService.generateOperationsChartDatas(monthlyuserstatistics);
              },
              statWeeklyUserGraphDataCount: function (GraphOptionsService, weeklyuserstatistics) {
                return GraphOptionsService.generateOperationsChartDatas(weeklyuserstatistics);
              },
              statDailyUserGraphDataCount: function (GraphOptionsService, dailyuserstatistics) {
                return GraphOptionsService.generateOperationsChartDatas(dailyuserstatistics);
              },
              statMonthlyGroupGraphDataCount: function (GraphOptionsService, monthlygroupstatistics) {
                return GraphOptionsService.generateOperationsChartDatas(monthlygroupstatistics);
              },
              statWeeklyGroupGraphDataCount: function (GraphOptionsService, weeklygroupstatistics) {
                return GraphOptionsService.generateOperationsChartDatas(weeklygroupstatistics);
              },
              statDailyGroupGraphDataCount: function (GraphOptionsService, dailygroupstatistics) {
                return GraphOptionsService.generateOperationsChartDatas(dailygroupstatistics);
              },
              Datas: function (GraphOptionsService, statMonthlyDomainGraphDataSum, statWeeklyDomainGraphDataSum, statDailyDomainGraphDataSum,
                ...
                return GraphOptionsService.buildGraphData(statMonthlyDomainGraphDataSum, statWeeklyDomainGraphDataSum, statDailyDomainGraphDataSum,
                  statMonthlyUserGraphDataSum, statWeeklyUserGraphDataSum, statDailyUserGraphDataSum,
                  statMonthlyGroupGraphDataSum, statWeeklyGroupGraphDataSum, statDailyGroupGraphDataSum,
                  statMonthlyDomainUsedSpaceGraphData, statWeeklyDomainUsedSpaceGraphData, statDailyDomainUsedSpaceGraphData,
                  statMonthlyUserUsedSpaceGraphData, statWeeklyUserUsedSpaceGraphData, statDailyUserUsedSpaceGraphData,
      ...
      .state('statistic.basic', {
        url: '/:domainId?resource&action',
        views: {
          'tree': domainTreeView,
          'graph': {
            templateUrl: 'ng_components/statistics/basic-statistics/basic-statistics_graph.tpl.html',
            controller: 'BasicStatisticGraphCtrl',
            resolve: {
              currentDomain: function (Domain, $stateParams) {
                return Domain.get($stateParams.domainId);
              },
              graphOptions: function (GraphOptionsService) {
                return GraphOptionsService.generateCountChartOptions();
              },
              currentResource: function ($stateParams) {
                return $stateParams.resource;
              },
              Data: function (basicStatistic, $stateParams) {
                return basicStatistic.getAllBasicSatistics($stateParams.domainId, $stateParams.resource);
              },
              graphDatas: function (GraphDatasService, basicSatistics) {
                return GraphDatasService.generateGraphDatas(basicSatistics);
              },
              basicSatistics: function (basicStatistic, $stateParams) {
                return basicStatistic.getBasicSatistics($stateParams.domainId, $stateParams.resource, $stateParams.action);
              },
              resourceTypes: enumResourceTypes,
              currentAction: function ($stateParams) {
      ...
      .state('statistic.exception', {
        url: '/:domainId',
        views: {
          'tree': domainTreeView,
          'graph': {
            templateUrl: 'ng_components/statistics/exception-statistics/exception-statistics_graph.tpl.html',
            controller: 'ExceptionStatisticGraphCtrl',
            resolve: {
              currentDomain: function (Domain, $stateParams) {
                return Domain.get($stateParams.domainId);
              },
