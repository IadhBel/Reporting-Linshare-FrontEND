...
angular
  ...
  .controller('UserDetailCtrl',
    ['_', '$filter', '$log', '$modal', '$rootScope', '$scope', '$state', '$timeout', 'currentUser',
      ...
      'restrictedGuestStatus', 'selectOptions', 'unitService', 'User', 'fileSizeChartOptions', 'operationsChartOptions', 'UserDatas',
    ...
    function (_, $filter, $log, $modal, $rootScope, $scope, $state, $timeout, currentUser, graphService,
        ...
        selectOptions, unitService, User, fileSizeChartOptions, operationsChartOptions, UserDatas) {
        ...
        $scope.userSumDatas = UserDatas.statUserMonthlyGraphDataSum;
        $scope.userUsedSpaceDatas = UserDatas.statUserMonthlyUsedSpaceGraphData;
        $scope.userCountDatas = UserDatas.statUserMonthlyGraphDataCount;
        ...
        $scope.userFileSizeDetail = function () {
          switch ($scope.userlabel) {
            case 'STATISTICS.SUM_STATISTICS.SIZE.DAILY':
              $scope.userSumDatas = UserDatas.statUserMonthlyUsedSpaceGraphData; $scope.userlabel = 'STATISTICS.SUM_STATISTICS.SIZE.MONTHLY';
              break;
            case 'STATISTICS.SUM_STATISTICS.SIZE.WEEKLY':
              $scope.userSumDatas = UserDatas.statUserWeeklyGraphDataSum; $scope.userlabel = 'STATISTICS.SUM_STATISTICS.SIZE.DAILY';
              break;
            case 'STATISTICS.SUM_STATISTICS.SIZE.MONTHLY':
              $scope.userSumDatas = UserDatas.statUserDailyGraphDataSum; $scope.userlabel = 'STATISTICS.SUM_STATISTICS.SIZE.WEEKLY';
              break;
          };
        };
        $scope.userUsedSpaceDetail = function () {
          switch ($scope.userUsedSpaceLabel) {
            case 'STATISTICS.SUM_STATISTICS.USED_SPACE.DAILY':
              $scope.userUsedSpaceDatas = UserDatas.statUserMonthlyUsedSpaceGraphData; $scope.userUsedSpaceLabel = 'STATISTICS.SUM_STATISTICS.USED_SPACE.MONTHLY';
              break;
            case 'STATISTICS.SUM_STATISTICS.USED_SPACE.WEEKLY':
              $scope.userUsedSpaceDatas = UserDatas.statUserWeeklyUsedSpaceGraphData; $scope.userUsedSpaceLabel = 'STATISTICS.SUM_STATISTICS.USED_SPACE.DAILY';
              break;
            case 'STATISTICS.SUM_STATISTICS.USED_SPACE.MONTHLY':
              $scope.userUsedSpaceDatas = UserDatas.statUserDailyUsedSpaceGraphData; $scope.userUsedSpaceLabel = 'STATISTICS.SUM_STATISTICS.USED_SPACE.WEEKLY';
              break;
          };
        };
        $scope.userOperationCountDetail = function () {
          switch ($scope.userOperationCountLabel) {
            case 'STATISTICS.COUNT_STATISTICS.OPERATION_COUNT.DAILY':
              $scope.userCountDatas = UserDatas.statUserMonthlyGraphDataCount; $scope.userOperationCountLabel = 'STATISTICS.COUNT_STATISTICS.OPERATION_COUNT.MONTHLY';
              break;
            case 'STATISTICS.COUNT_STATISTICS.OPERATION_COUNT.WEEKLY':
              $scope.userCountDatas = UserDatas.statUserWeeklyGraphDataCount; $scope.userOperationCountLabel = 'STATISTICS.COUNT_STATISTICS.OPERATION_COUNT.DAILY';
              break;
            case 'STATISTICS.COUNT_STATISTICS.OPERATION_COUNT.MONTHLY':
              $scope.userCountDatas = UserDatas.statUserDailyGraphDataCount; $scope.userOperationCountLabel = 'STATISTICS.COUNT_STATISTICS.OPERATION_COUNT.WEEKLY';
              break;
          };
        };
      }
